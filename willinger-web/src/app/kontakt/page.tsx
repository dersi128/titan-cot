...
export const metadata: Metadata = {
  title: "Kontakt",
  description: `Anfrage an ${site.name} in Untermarkersdorf. Telefon, Fax und E-Mail.`,
};
...
export default function KontaktPage() {
  return (
    <>
      <PageHero
        kicker="Kontakt"
        title="Ein Angebot aus eigener Verarbeitung"
        lead="Schreiben Sie uns Menge, Wunschtermin und ob Abholung oder gekühlter Transport gewünscht ist."
