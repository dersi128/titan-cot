...
/** Deterministic PRNG from string seed (symbol-specific curves). */
...
/** Symbol-specific seasonal amplitude & phase for synthetic but stable mock paths. */
const SYMBOL_SEASON = {
...
/**
 * Generates business-day OHLC from a geometric Brownian-style path with embedded seasonality.
 * Replace this provider when wiring Yahoo / TwelveData / Polygon / CSV / API.
 */
