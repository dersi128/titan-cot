  ...
  return (
    <header className="titan-page-header mb-4 flex flex-col gap-3 border-b border-white/[0.06] pb-4 md:flex-row md:items-end md:justify-between">
      <div className="min-w-0">
        <p className="font-display text-[10px] font-semibold uppercase tracking-[0.14em] text-titan-gold/85">{eyebrow}</p>
        <h2 className="mt-1.5 font-display text-xl font-bold uppercase tracking-[0.06em] text-stone-50 md:text-2xl">
          {title}
        </h2>
