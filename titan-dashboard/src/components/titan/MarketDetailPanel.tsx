...
import { TitanMarketEngine } from "./TitanMarketEngine";
...
export function MarketDetailPanel({ market, data, loading, error }: MarketDetailPanelProps) {
  ...
  return (
    ...
    <TitanPanel className="titan-detail-panel overflow-hidden p-0">
      ...
      <TitanMarketEngine market={market} data={data} loading={loading} />



      <div className="border-t border-white/[0.06] px-5 pb-6 md:px-7">
      ...
      <div className="space-y-8 border-t border-white/[0.06] p-5 md:p-6">
