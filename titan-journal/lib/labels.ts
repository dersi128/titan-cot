...
export const copy = {
  ...
  detail: {
    ...
    setupValid: "Setup valid according to strategy?",
    ...
    emotionalOptional: "Optional",
    learningNote: "What did I learn from this trade?",
    nextTimeNote: "What would I do differently next time?",
    ...
    planFollowedShort: "Plan followed",
    setupValidShort: "Setup valid",
    wouldTakeAgainShort: "Would take again",
    tags: "Tags",
    result: "Result",
    resultNotQuality: "Result ≠ Quality",
    lostButCorrect:
      "The trade lost money but was executed correctly.",
    wonButNeedsReview:
      "The trade made money, but execution still needs review.",
    reviewIncomplete: "Select Plan followed, Setup valid, Would take again, and Execution Quality.",
    yes: "Yes",
    no: "No",
    partially: "Partially",
    htfTrend: "HTF trend",
